...
grow_speed = 0.42  # Speed for growing 4 seconds (Function source is written below) #speed was calculated by me
shrink_speed = 0.21  # Speed for shrinking 8 seconds (Function source is written below) #speed was calculated by me
...
def draw():
    ...
    fill(185, 232, 255)  # circle filled light blue colour
